...
if [ ! -f ~/android-sdk/platforms/android-34/android.jar ]; then
    echo "Downloading minimal Android 34 SDK (android.jar)..."
    # This is a common location for a standalone android.jar for build purposes
    wget -qO ~/android-sdk/platforms/android-34/android.jar "https://github.com/S6-S6/android-sdk-platforms/raw/master/android-34/android.jar"
fi
